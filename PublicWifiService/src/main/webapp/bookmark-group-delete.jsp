...
<body>
	...
	%>
	<h1 style="margin:8px">북마크 그룹 삭제하기</h1>
	...
	<form action="bookmark-group-delete-submit.jsp?id=<%=id %>" method="post" style="margin:8px">
	<table>
		<tr>
			<th>북마크 이름</th>
			<th>순서</th>
		...
		<tr>
			<td><input type="text" id="bookmarkName" name="bookmarkName" value="<%=name %>"/></td>
			<td><input type="text" id="order" name="order" value="<%=order %>"/></td>
		</tr>			
	</table>
